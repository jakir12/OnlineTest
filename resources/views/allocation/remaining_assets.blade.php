...
@section('title',"Remaining Asset List")
@section('content')
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Remaining Asset
            <small>Remaining Asset List</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Remaining Asset</a></li>
            <li class="active">Remaining Asset List</li>
        </ol>
    </section>
    <!-- Main content -->
            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Remaining Asset List</h3>
